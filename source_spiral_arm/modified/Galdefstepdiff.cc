...
int Galdef::read ( const string& theVersion,
    ...
    strcpy (parstring,                                "z_step" );
    stat = read_galdef_parameter (filename,parstring,&z_step);	
    ...
    strcpy (parstring,                              "D_fact"); //SB20170323
    stat = read_galdef_parameter (filename,parstring,&D_fact); //SB20170323    	

    //diffusion coefficient in TeV region YO/20140511
    strcpy ( parstring,                              "diff_TeV" );
    stat= read_galdef_parameter ( filename,parstring,&diff_TeV );
    strcpy ( parstring,                              "D0_xx_TeV" );
    stat= read_galdef_parameter ( filename,parstring,&D0_xx_TeV );
    strcpy ( parstring,                              "D_rigid_br_TeV" );
    stat= read_galdef_parameter ( filename,parstring,&D_rigid_br_TeV );
    strcpy ( parstring,                              "D_g_TeV" );
    stat= read_galdef_parameter ( filename,parstring,&D_g_TeV );
    ...
    strcpy(parstring,                              "DM_mass"                ); //YO/20151012
    stat= read_galdef_parameter(filename,parstring,&DM_mass                 );
    strcpy(parstring,                              "DM_boostfactor"         ); //YO/20151012
    stat= read_galdef_parameter(filename,parstring,&DM_boostfactor          );
    strcpy(parstring,                              "DM_sigmav"              ); //YO/20151012
    stat= read_galdef_parameter(filename,parstring,&DM_sigmav               );
    strcpy(parstring,                              "DM_model"               ); //YO/20151012 
    stat= read_galdef_parameter(filename,parstring,&DM_model                );

    // time dependent injection
    strcpy(parstring,                              "primary_TD_positron"    ); //YO/20140220->20140408 changed 
    stat= read_galdef_parameter(filename,parstring,&primary_TD_positron     ); //YO/20140220->20140408 changed 
    strcpy(parstring,                              "primary_TD_electron"    ); //YO/20140408 
    stat= read_galdef_parameter(filename,parstring,&primary_TD_electron     ); //YO/20140408

    strcpy(parstring,                                   "t_TDmax"           ); //YO/20140310 
    stat= read_galdef_parameter(filename,parstring,&t_TDmax                 ); //YO/20140310
    strcpy(parstring,                                   "t_TDmin"           ); //YO/20140310 
    stat= read_galdef_parameter(filename,parstring,&t_TDmin                 ); //YO/20140310
    

    strcpy(parstring,                                   "source_age"        ); //YO/20140325 
    stat= read_galdef_parameter(filename,parstring,&source_age              ); //YO/20140325

    //SNR electron injection model
    strcpy(parstring,                                   "TD_SNR_model"      ); //YO/20140425
    stat= read_galdef_parameter(filename,parstring,&TD_SNR_model            ); //YO/20140425

    //single source spectrum parameters YO/20141117
    strcpy(parstring,                                   "total_energy"      );
    stat= read_galdef_parameter(filename,parstring,&total_energy            );
    /*strcpy(parstring,                                   "power_law"         );
      stat= read_galdef_parameter(filename,parstring,&power_law               );*/
    strcpy(parstring,                                   "power_law_1"       );
    stat= read_galdef_parameter(filename,parstring,&power_law_1             );
    strcpy(parstring,                                   "power_law_2"       );
    stat= read_galdef_parameter(filename,parstring,&power_law_2             );
    strcpy(parstring,                                   "power_law_br"      );
    stat= read_galdef_parameter(filename,parstring,&power_law_br            );
    strcpy (parstring,                                  "inj_energy_cutoff" ); //YO20151211
    stat= read_galdef_parameter(filename,parstring,&inj_energy_cutoff       );
    strcpy(parstring,                                   "energy_cutoff"     );
    stat= read_galdef_parameter(filename,parstring,&energy_cutoff           );
    strcpy(parstring,                                   "SNR_x"             );
    stat= read_galdef_parameter(filename,parstring,&SNR_x                   );
    strcpy(parstring,                                   "SNR_y"             );
    stat= read_galdef_parameter(filename,parstring,&SNR_y                   );
    strcpy(parstring,                                   "SNR_z"             );
    stat= read_galdef_parameter(filename,parstring,&SNR_z                   );
    strcpy(parstring,                                   "latitude"          ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&latitude                );
    strcpy(parstring,                                   "longitude"         ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&longitude               );
    strcpy(parstring,                                   "distance"          ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&distance                );
    
    //random distance
    strcpy(parstring,                                   "random_coordinate" ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&random_coordinate       );
    strcpy(parstring,                                   "rand_max"          ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&rand_max                );
    strcpy(parstring,                                   "rand_min"          ); //YO/20141213
    stat= read_galdef_parameter(filename,parstring,&rand_min                );

    //random age
    strcpy(parstring,                                   "random_age"        ); //YO/20141224
    stat= read_galdef_parameter(filename,parstring,&random_age              );
    strcpy(parstring,                                   "rant_max"          ); //YO/20141224
    stat= read_galdef_parameter(filename,parstring,&rant_max                );
    strcpy(parstring,                                   "rant_min"          ); //YO/20141224
    stat= read_galdef_parameter(filename,parstring,&rant_min                );
    
    // exclude nearby sources
    strcpy(parstring,                           "rm_nearbysource"           ); //YO/20140314 
    stat= read_galdef_parameter(filename,parstring,&rm_nearbysource         ); //YO/20140314
    strcpy(parstring,                             "near_distance"           ); //YO/20140314 
    stat= read_galdef_parameter(filename,parstring,&near_distance           ); //YO/20140314
    strcpy(parstring,                             "near_distance2"          );
    stat= read_galdef_parameter(filename,parstring,&near_distance2          );
    strcpy(parstring,                             "near_distance3"          );
    stat= read_galdef_parameter(filename,parstring,&near_distance3          );
    strcpy(parstring,                             "near_distance4"          );
    stat= read_galdef_parameter(filename,parstring,&near_distance4          );
    strcpy(parstring,                             "near_age"                ); //YO/20140612 
    stat= read_galdef_parameter(filename,parstring,&near_age                ); //YO/20140612
    //strcpy(parstring,                            "exponfactor"              ); //SB/20161110
    //stat= read_galdef_parameter(filename,parstring,&exponfactor             ); //SB/20161110

    //parameter for check
    strcpy(parstring,                             "check_num"               ); //YO/20140325 
    stat= read_galdef_parameter(filename,parstring,&check_num               ); //YO/20140325
...
void Galdef::print() {
    ...
    cout<<"  z_step   "<<z_step  <<endl;  //SB20170323
    cout<<"  dz       "<<dz      <<endl;
    ...
    cout<<"  D_step      "<<D_step        <<endl; // SB20170323
...
// DM: IMOS20050912
    ...
    cout<<"  DM_mass "<<DM_mass                                 <<endl;  //YO/20151012
    cout<<"  DM_boostfactor "<<DM_boostfactor                   <<endl;  //YO/20151012
    cout<<"  DM_sigmav "<<DM_sigmav                             <<endl;  //YO/20151012
    cout<<"  DM_Annihilation_model "<<DM_model                  <<endl;  //YO/20151012

    // time_dependent_injection
    cout<<"  primary_TD_positron  "<< primary_TD_positron <<endl; //YO/20140220 -> 20140408 changed 
    cout<<"  primary_TD_electron  "<< primary_TD_electron <<endl; //YO/20140408 
    cout<<"  t_TDmax              "<< t_TDmax      <<endl; //YO/20140310 
    cout<<"  t_TDmin              "<< t_TDmin      <<endl; //YO/20140310 
    cout<<"  source_age           "<< source_age   <<endl; //YO/20140325

    //SNR electron injection model
    cout<<"  TD_SNR_model         "<< TD_SNR_model <<endl; //YO/20140425 

    //single source spectrum parameters YO/20141117
    cout<<"  total_energy         "<< total_energy <<endl; 
      //cout<<"  power_law      "<< power_law <<endl;
    cout<<"  power_law_1          "<< power_law_1 << endl;
    cout<<"  power_law_2          "<< power_law_2 << endl;
    cout<<"  power_law_br         "<< power_law_br << endl;
    cout<<"  inj_energy_cutoff    "<< inj_energy_cutoff <<endl;
    cout<<"  energy_cutoff        "<< energy_cutoff <<endl;
    cout<<"  source coordinate    "<<"("<<SNR_x<<","<<SNR_y<<","<<SNR_z<<")"<<endl;
    cout<<"  latitude             "<< latitude << endl;  //YO/20141213
    cout<<"  longitude            "<< longitude << endl; //YO/20141213
    cout<<"  distance             "<< distance << endl; //YO/20141224

    //random calculation YO/20141213
    cout<<"  random_coordinate    "<< random_coordinate << endl;
    cout<<"  rand_max             "<< rand_max << endl;
    cout<<"  rand_min             "<< rand_min << endl;

    //random calculation YO/20141213
    cout<<"  random_age           "<< random_age << endl; //YO/20141224
    cout<<"  rant_max             "<< rant_max << endl;   //YO/20141224
    cout<<"  rant_min             "<< rant_min << endl;   //YO/20141224

    // exclude nearby CR sources
    cout<<"  rm_nearbysource  "<< rm_nearbysource <<endl; //YO/20140314 
    cout<<"  near_distance    "<< near_distance   <<endl; //YO/20140314 
    cout<<"  near_distance2   "<< near_distance2  <<endl;
    cout<<"  near_distance3   "<< near_distance3  <<endl; 
    cout<<"  near_distance4   "<< near_distance4  <<endl;
    cout<<"  near_age         "<< near_age        <<endl; //YO/20140612 
    //cout<<"  exponfactor      "<< exponfactor     <<endl; //SB/20161110

    // diffusion coefficient in TeV region  YO/20140511                                                                                                                             
    cout<<"  diff_TeV         "<< diff_TeV <<endl;
    cout<<"  D0_xx_TeV        "<< D0_xx_TeV <<endl;
    cout<<"  D_rigid_br_TeV   "<< D_rigid_br_TeV <<endl;
    cout<<"  D_g_TeV          "<< D_g_TeV <<endl;

    cout<<"  check_num        "<< check_num       <<endl; //YO/20140325 
